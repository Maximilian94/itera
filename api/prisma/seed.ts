    ...
    data: [
      {
        ...
        requirements: 'Superior em Análise de Sistemas ou áreas afins',
      ...
      },
      {
        ...
        registrationStart: new Date('2026-05-04T00:00:00.000Z'),
        registrationEnd: new Date('2026-06-15T23:59:59.000Z'),
        resultDate: new Date('2026-10-30T00:00:00.000Z'),
        requirements: 'Superior em Ciência da Computação ou áreas afins',
        editalUrl: 'https://example.com/editais/governo-mg-2026.pdf',
        examBoardId: fgv.id,
        published: true,
        slug: 'fgv-mg-2026-desenvolvedor',
      },
      {
        // Cargo de enfermagem com histórico: edição atual (futura) +
        // 3 edições anteriores abaixo. Exercita previousExams, distribuição
        // histórica (MAX-17) e concorrência histórica (MAX-18).
        id: randomUUID(),
        name: 'Prefeitura - Enfermeiro',
        institution: 'Prefeitura Municipal',
        role: 'Enfermeiro',
        governmentScope: GovernmentScope.MUNICIPAL,
        state: 'SP',
        city: 'São Paulo',
        salaryBase: new Prisma.Decimal('6800.00'),
        examDate: new Date('2026-06-15T00:00:00.000Z'),
        registrationStart: new Date('2026-03-01T00:00:00.000Z'),
        registrationEnd: new Date('2026-04-10T23:59:59.000Z'),
        resultDate: new Date('2026-08-30T00:00:00.000Z'),
        requirements: 'Superior em Enfermagem + registro no COREN',
        vacancyCount: 25,
        minPassingGradeNonQuota: new Prisma.Decimal('60.00'),
        editalUrl: 'https://example.com/editais/prefeitura-sp-2026.pdf',
        examBoardId: cespe.id,
        published: true,
        slug: 'cebraspe-sp-sao-paulo-2026-enfermeiro',
      },
      {
        // Edição 2024: dados completos de concorrência (inclusive corte real).
        id: randomUUID(),
        name: 'Prefeitura - Enfermeiro (2024)',
        institution: 'Prefeitura Municipal',
        role: 'Enfermeiro',
        governmentScope: GovernmentScope.MUNICIPAL,
        state: 'SP',
        city: 'São Paulo',
        salaryBase: new Prisma.Decimal('6200.00'),
        examDate: new Date('2024-05-12T00:00:00.000Z'),
        vacancyCount: 20,
        applicantCount: 1786,
        minPassingGradeNonQuota: new Prisma.Decimal('60.00'),
        actualCutScore: new Prisma.Decimal('74.50'),
        examBoardId: cespe.id,
        published: true,
        slug: 'cebraspe-sp-sao-paulo-2024-enfermeiro',
      },
      {
        // Edição 2022: tem inscritos mas não tem nota — exercita nulls.
        id: randomUUID(),
        name: 'Prefeitura - Enfermeiro (2022)',
        institution: 'Prefeitura Municipal',
        role: 'Enfermeiro',
        governmentScope: GovernmentScope.MUNICIPAL,
        state: 'SP',
        city: 'São Paulo',
        salaryBase: new Prisma.Decimal('5400.00'),
        examDate: new Date('2022-04-03T00:00:00.000Z'),
        vacancyCount: 12,
        applicantCount: 943,
        examBoardId: cespe.id,
        published: true,
        slug: 'cebraspe-sp-sao-paulo-2022-enfermeiro',
      },
      {
        // Edição 2020: sem nenhum dado de concorrência — deve ficar fora da
        // tabela de concorrência histórica (MAX-18), mas conta como prova
        // anterior para treino.
        id: randomUUID(),
        name: 'Prefeitura - Enfermeiro (2020)',
        institution: 'Prefeitura Municipal',
        role: 'Enfermeiro',
        governmentScope: GovernmentScope.MUNICIPAL,
        state: 'SP',
        city: 'São Paulo',
        examDate: new Date('2020-03-08T00:00:00.000Z'),
        examBoardId: cespe.id,
        published: true,
        slug: 'cebraspe-sp-sao-paulo-2020-enfermeiro',
      },
      {
        id: randomUUID(),
        ...
        registrationStart: new Date('2026-07-01T00:00:00.000Z'),
        registrationEnd: new Date('2026-08-10T23:59:59.000Z'),
        resultDate: new Date('2026-12-15T00:00:00.000Z'),
        requirements: 'Superior em Engenharia de Software ou áreas afins',
        editalUrl: 'https://example.com/editais/orgao-federal-2026.pdf',
        examBoardId: cespe.id,
        published: true,

...
An ExamService is a user-owned entity that represents a single “prova” session.

Rules:

- ExamService questions are selected once at exam creation time and then frozen.
- A question must not repeat inside the same ExamService.

...
import { CargoLinksSection } from '@/features/cargo/components/CargoLinksSection'
  ...
  return (
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <Stack spacing={2}>
        ...
        {/* Remodelagem R4.3: vínculos cargo↔prova geridos pelo serviço de
            Cargo — cargo default nasce ao salvar com instituição; aqui o admin
            compartilha a prova com outros cargos e elege a oficial. */}
        <CargoLinksSection
          examBaseId={examBaseId}
          concursoId={examBase?.concurso?.id ?? null}
        />
        <TextField
    ...
    <div className="flex flex-col gap-6">
      <Box sx={{ border: '1px solid', borderColor: 'divider', borderRadius: 2, p: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary" mb={2.5}>
          Envie o PDF da prova. O OCR extrairá o conteúdo e GPT-4.1-mini estruturará as questões.
        </Typography>
        ...
        <ToggleButtonGroup
          value={ocrProvider}
          exclusive
          onChange={(_, v) => { if (v) setOcrProvider(v) }}
          size="small"
          sx={{ mb: 2 }}
          disabled={isParsing}
        >

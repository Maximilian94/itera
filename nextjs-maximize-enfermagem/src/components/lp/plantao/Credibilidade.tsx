...
const pilares = [
    ...
    {
        name: "IA que respeita o seu tempo",
        description:
            "Nossa IA não te entrega cronograma maximalista. Ela mostra onde cada hora estudada gera o maior salto de pontos — pra quem tem 1h livre, isso é a diferença entre passar e tentar de novo.",
        icon: CpuChipIcon,
    },
    {
        name: "Construído por enfermeiros aprovados",
        description:
            "Cada análise passa por revisão de enfermeiras que conciliaram plantão e estudo até a aprovação. Quem te orienta já passou por onde você está passando.",
        ...
        >
            ...
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    >
                        Construído pra quem tem pouca margem com o tempo.
                    </h2>
                    <p className="mt-6 text-lg leading-8 text-sky-200">
                        Cada minuto que você gasta estudando é avaliado por uma IA treinada com o histórico real da sua
                        banca. Não é cronograma de prateleira.
                    </p>
                </div>

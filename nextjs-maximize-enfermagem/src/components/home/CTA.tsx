        ...
        <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
            <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
              <h2 className="text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Veja na prática como você evolui.</h2>
              <p className="mt-6 text-xl/8 text-gray-700">
              Faça um treino gratuito e descubra exatamente o que precisa melhorar para chegar mais preparado no concurso.
              </p>
            ...
            <div className="flex flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents">
              <div className="w-0 flex-auto lg:ml-auto lg:w-auto lg:flex-none lg:self-end">
                <img
                  alt=""
                  src="/estudante-de-medicina-pensando-ou-escrevendo-livros-em-pesquisa-educacao-bem-estar-estudo-ou-aprendizado-hospitalar-enfermeira-de-laptop-ou-mulher-de-saude-e-tecnologia-de-notebook-ou-bolsa-de-estagio-em-medicina_590464-148297.avif"

...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-cyan-600 to-cyan-800 text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36">
        <div className="max-w-3xl">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight">
            ...
            <span className="text-cyan-200">exclusivamente</span> para
            enfermeiros
          </h1>
          <p className="mt-6 text-lg sm:text-xl text-cyan-100 leading-relaxed max-w-2xl">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Link
              ...
              className="inline-flex items-center justify-center rounded-lg bg-white px-8 py-3.5 text-base font-semibold text-cyan-700 shadow-lg hover:bg-cyan-50 transition-colors"
            >

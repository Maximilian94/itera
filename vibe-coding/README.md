...
- [2026-07 — Design da remodelagem Cargo↔Prova (R3.1)](./2026-07-remodelagem-cargo-prova-design.md) — modelo alvo Concurso→Cargo→CargoProva→ExamBase (M:N), mapa de campos que migram/ficam, invariantes (1 oficial por cargo via unique parcial), backfill e estratégia de contrato estável. **Aguardando aprovação antes do R3.2.**
